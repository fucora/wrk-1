...
// Enables the specified privilege.
{
    ...
    result = AdjustTokenPrivileges(hToken, FALSE, &tpPrevious, sizeof(TOKEN_PRIVILEGES), NULL, NULL);
...
void main(int argc, char *argv[])
{
    ...
    if (argv[1][0] == 't') {
        ...
        while (CreateProcess("testlimit.exe", minws ? "testlimit n" : "testlimit t", NULL, NULL, FALSE, 0, NULL, NULL, &startup, &procinfo)) {
            i++;
