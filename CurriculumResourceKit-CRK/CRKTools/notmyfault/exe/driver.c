...
HANDLE		SysHandle = INVALID_HANDLE_VALUE;// Driver handle
...
*/
{
    ...
    //       Group, and/or Dependencies, it may be necessary to query the registry for existing driver information
...
*/
{
    ...
    RemoveDriver(schSCManager, Name);// Remove old instances	
    InstallDriver(schSCManager, Name, Path);// Ignore success of installation: it may already be installed.	
    StartDriver(schSCManager, Name);// Ignore success of start: it may already be started.
