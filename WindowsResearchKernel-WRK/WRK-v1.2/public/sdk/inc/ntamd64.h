...
#define UNW_FLAG_CHAININFO 0x4
    ...
    {// Define unwind information structure.
        ...
        // contains the exception handler address or a function table entry if chained unwind information is specified.
...
#define UNWIND_HISTORY_TABLE_LOCAL 2
    ...
    NTSYSAPI PEXCEPTION_ROUTINE RtlVirtualUnwind(IN ULONG HandlerType,
