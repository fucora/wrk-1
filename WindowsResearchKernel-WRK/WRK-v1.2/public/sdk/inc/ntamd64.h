...
#define WOW64_COMPATIBILITY_AREA_ADDRESS (MM_SHARED_USER_DATA_VA - 0x1000000)// Define address of the WOW64 reserved compatibility area.
#define CSR_SYSTEM_SHARED_ADDRESS (WOW64_COMPATIBILITY_AREA_ADDRESS)// Define address of the system-wide csrss shared section.
...
BOOLEAN _bittest (IN LONG const *Base, IN LONG Offset);
BOOLEAN _bittestandcomplement (IN LONG *Base, IN LONG Offset);
BOOLEAN _bittestandset (IN LONG *Base, IN LONG Offset);
BOOLEAN _bittestandreset (IN LONG *Base, IN LONG Offset);
...
BOOLEAN _bittest64 (IN LONG64 const *Base, IN LONG64 Offset);
BOOLEAN _bittestandcomplement64 (IN LONG64 *Base, IN LONG64 Offset);
BOOLEAN _bittestandset64 (IN LONG64 *Base, IN LONG64 Offset);
BOOLEAN _bittestandreset64 (IN LONG64 *Base, IN LONG64 Offset);
BOOLEAN _interlockedbittestandset64 (IN LONG64 *Base, IN LONG64 Offset);
BOOLEAN _interlockedbittestandreset64 (IN LONG64 *Base, IN LONG64 Offset);
...
SHORT InterlockedDecrement16 (IN OUT SHORT volatile *Addend);
...
ULONG __segmentlimit (IN ULONG Selector);
...
VOID __movsb (IN PUCHAR Destination, IN UCHAR const *Source, IN SIZE_T Count);
VOID __movsw (IN PUSHORT Destination, IN USHORT const *Source, IN SIZE_T Count);
VOID __movsd (IN PULONG Destination, IN ULONG const *Source, IN SIZE_T Count);
VOID __movsq (IN PULONG64 Destination, IN ULONG64 const *Source, IN SIZE_T Count);
...
VOID __stosb (IN PUCHAR Destination, IN UCHAR Value, IN SIZE_T Count);
VOID __stosw (IN PUSHORT Destination, IN USHORT Value, IN SIZE_T Count);
VOID __stosd (IN PULONG Destination, IN ULONG Value, IN SIZE_T Count);
VOID __stosq (IN PULONG64 Destination, IN ULONG64 Value, IN SIZE_T Count);
...
LONGLONG MultiplyHigh (IN LONGLONG Multiplier, IN LONGLONG Multiplicand);
ULONGLONG UnsignedMultiplyHigh (IN ULONGLONG Multiplier, IN ULONGLONG Multiplicand);
...
ULONG64 ShiftLeft128 (IN ULONG64 LowPart, IN ULONG64 HighPart, IN UCHAR Shift);
ULONG64 ShiftRight128 (IN ULONG64 LowPart, IN ULONG64 HighPart, IN UCHAR Shift);
...
LONG64 Multiply128 (IN  LONG64  Multiplier, IN  LONG64  Multiplicand, OUT LONG64 *HighProduct);
...
__forceinline LONG64 MultiplyExtract128 (IN LONG64 Multiplier, IN LONG64 Multiplicand, IN UCHAR Shift)
{
...
__forceinline ULONG64 UnsignedMultiplyExtract128 (IN ULONG64 Multiplier, IN ULONG64 Multiplicand, IN UCHAR Shift)
{
...
UCHAR __readgsbyte (IN ULONG Offset);
USHORT __readgsword (IN ULONG Offset);
ULONG __readgsdword (IN ULONG Offset);
ULONG64 __readgsqword (IN ULONG Offset);
VOID __writegsbyte (IN ULONG Offset, IN UCHAR Data);
VOID __writegsword (IN ULONG Offset, IN USHORT Data);
VOID __writegsdword (IN ULONG Offset, IN ULONG Data);
VOID __writegsqword (IN ULONG Offset, IN ULONG64 Data);
...
// of the exception record whan the exception code specifies an access violation.
...
typedef PRUNTIME_FUNCTION (*PGET_RUNTIME_FUNCTION_CALLBACK) (IN ULONG64 ControlPc, IN PVOID Context);
...
typedef NTSTATUS (*POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK) (IN HANDLE Process, IN PVOID TableAddress, OUT PULONG Entries, OUT PRUNTIME_FUNCTION* Functions);
...
NTSYSAPI VOID __cdecl RtlRestoreContext (IN PCONTEXT ContextRecord, IN struct _EXCEPTION_RECORD *ExceptionRecord OPTIONAL);

// end_winnt

VOID RtlInitializeHistoryTable (VOID);
NTSYSAPI PRUNTIME_FUNCTION RtlLookupFunctionEntry (IN ULONG64 ControlPc, OUT PULONG64 ImageBase, IN OUT PUNWIND_HISTORY_TABLE HistoryTable OPTIONAL);
NTSYSAPI PRUNTIME_FUNCTION RtlLookupFunctionTable (IN PVOID ControlPc, OUT PVOID *ImageBase, OUT PULONG SizeOfTable);
NTSYSAPI PLIST_ENTRY RtlGetFunctionTableListHead (VOID);

#if defined(_AMD64_)

// begin_winnt

NTSYSAPI BOOLEAN __cdecl RtlAddFunctionTable (IN PRUNTIME_FUNCTION FunctionTable, IN ULONG EntryCount, IN ULONG64 BaseAddress);
...
NTSYSAPI BOOLEAN __cdecl RtlDeleteFunctionTable (IN PRUNTIME_FUNCTION FunctionTable);
