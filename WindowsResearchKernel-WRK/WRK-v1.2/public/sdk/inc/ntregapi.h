...
Abstract:
    This module contains the registration apis and related structures, in the forms for use with the Nt api set (as opposed to the win api set).
*/
...
NTSYSCALLAPI NTSTATUS NTAPI NtDeleteKey(__in HANDLE KeyHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtDeleteValueKey(__in HANDLE KeyHandle, __in PUNICODE_STRING ValueName);
...
NTSYSCALLAPI NTSTATUS NTAPI NtFlushKey(__in HANDLE KeyHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtInitializeRegistry(__in USHORT BootCondition);
...
NTSYSCALLAPI NTSTATUS NTAPI NtLoadKey(__in POBJECT_ATTRIBUTES TargetKey, __in POBJECT_ATTRIBUTES SourceFile);
NTSYSCALLAPI NTSTATUS NTAPI NtLoadKey2(__in POBJECT_ATTRIBUTES   TargetKey, __in POBJECT_ATTRIBUTES   SourceFile, __in ULONG Flags);
...
NTSYSCALLAPI NTSTATUS NTAPI NtOpenKey(__out PHANDLE KeyHandle, __in ACCESS_MASK DesiredAccess, __in POBJECT_ATTRIBUTES ObjectAttributes);
...
NTSYSCALLAPI NTSTATUS NTAPI NtRenameKey(__in HANDLE           KeyHandle, __in PUNICODE_STRING  NewName);
NTSYSCALLAPI NTSTATUS NTAPI NtCompactKeys(__in ULONG Count, __in_ecount(Count) HANDLE KeyArray[]);
NTSYSCALLAPI NTSTATUS NTAPI NtCompressKey(__in HANDLE Key);
NTSYSCALLAPI NTSTATUS NTAPI NtRestoreKey(__in HANDLE KeyHandle, __in HANDLE FileHandle, __in ULONG Flags);
NTSYSCALLAPI NTSTATUS NTAPI NtSaveKey(__in HANDLE KeyHandle, __in HANDLE FileHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtSaveKeyEx(__in HANDLE KeyHandle, __in HANDLE FileHandle, __in ULONG  Format);
NTSYSCALLAPI NTSTATUS NTAPI NtSaveMergedKeys(__in HANDLE HighPrecedenceKeyHandle, __in HANDLE LowPrecedenceKeyHandle, __in HANDLE FileHandle);
...
NTSYSCALLAPI NTSTATUS NTAPI NtUnloadKey(__in POBJECT_ATTRIBUTES TargetKey);
NTSYSCALLAPI NTSTATUS NTAPI NtUnloadKey2(__in POBJECT_ATTRIBUTES   TargetKey, __in ULONG Flags);
NTSYSCALLAPI NTSTATUS NTAPI NtUnloadKeyEx(__in POBJECT_ATTRIBUTES TargetKey, __in_opt HANDLE Event);
...
NTSYSCALLAPI NTSTATUS NTAPI NtQueryOpenSubKeys(__in POBJECT_ATTRIBUTES TargetKey, __out PULONG  HandleCount);
...
NTSYSCALLAPI NTSTATUS NTAPI NtLockRegistryKey(__in HANDLE           KeyHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtLockProductActivationKeys(__inout_opt ULONG   *pPrivateVer, __out_opt ULONG   *pSafeMode);
