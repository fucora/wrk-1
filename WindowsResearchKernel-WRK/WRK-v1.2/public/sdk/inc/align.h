...
// BOOL POINTER_IS_ALIGNED(
//     IN LPVOID Ptr,
//     IN DWORD Pow2      // undefined if this isn't a power of 2.
//     );
#define POINTER_IS_ALIGNED(Ptr,Pow2)         ( ( ( ((ULONG_PTR)(Ptr)) & (((Pow2)-1)) ) == 0) ? TRUE : FALSE )
#define ROUND_DOWN_COUNT(Count,Pow2)         ( (Count) & (~(((LONG)(Pow2))-1)) )
#define ROUND_DOWN_POINTER(Ptr,Pow2)         ( (LPVOID) ROUND_DOWN_COUNT( ((ULONG_PTR)(Ptr)), (Pow2) ) )


// If Count is not already aligned, then
// round Count up to an even multiple of "Pow2".  "Pow2" must be a power of 2.

// DWORD ROUND_UP_COUNT(IN DWORD Count, IN DWORD Pow2);
#define ROUND_UP_COUNT(Count,Pow2)         ( ((Count)+(Pow2)-1) & (~(((LONG)(Pow2))-1)) )

// LPVOID ROUND_UP_POINTER(IN LPVOID Ptr, IN DWORD Pow2);

// If Ptr is not already aligned, then round it up until it is.
#define ROUND_UP_POINTER(Ptr,Pow2)         ( (LPVOID) ( (((ULONG_PTR)(Ptr))+(Pow2)-1) & (~(((LONG)(Pow2))-1)) ) )
