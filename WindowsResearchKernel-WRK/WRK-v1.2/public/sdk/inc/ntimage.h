...
// the impact of these variable length objects on the alignment of the fixed size directory entry objects.
...
// decoding code point values within the resource data.  Typically for new applications the code page would be the unicode code page.
...
// IMAGE_DEBUG_DIRECTORY structures.  The latter structures and those in the image file contain file offsets relative to the beginning of the .DBG file.

// If symbols have been stripped from an image, the IMAGE_DEBUG_MISC structure
// is left in the image file, but not mapped.  This allows a debugger to compute the name of the .DBG file, from the name of the image in the IMAGE_DEBUG_MISC structure.
...
// The structure is used by the NT loader for clr URT support.  It is a duplicate of the definition in corhdr.h.
...
typedef struct IMAGE_COR20_HEADER
{
    ...
    IMAGE_DATA_DIRECTORY    ManagedNativeHeader;// Precompiled image info (internal use only - set to zero)
