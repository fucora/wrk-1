...
Abstract:
    This module is the header file for the all the system services that are contained in the "ex" directory.
*/
...
NTSYSCALLAPI NTSTATUS NTAPI NtDelayExecution (__in BOOLEAN Alertable, __in PLARGE_INTEGER DelayInterval);
...
NTSYSCALLAPI NTSTATUS NTAPI NtAddBootEntry (__in PBOOT_ENTRY BootEntry, __out_opt PULONG Id);
NTSYSCALLAPI NTSTATUS NTAPI NtDeleteBootEntry (__in ULONG Id);
NTSYSCALLAPI NTSTATUS NTAPI NtModifyBootEntry (__in PBOOT_ENTRY BootEntry);
NTSYSCALLAPI NTSTATUS NTAPI NtEnumerateBootEntries (__out_bcount_opt(*BufferLength) PVOID Buffer, __inout PULONG BufferLength);
...
NTSYSCALLAPI NTSTATUS NTAPI NtQueryBootEntryOrder (__out_ecount_opt(*Count) PULONG Ids, __inout PULONG Count);
NTSYSCALLAPI NTSTATUS NTAPI NtSetBootEntryOrder (__in_ecount(Count) PULONG Ids, __in ULONG Count);
NTSYSCALLAPI NTSTATUS NTAPI NtQueryBootOptions (__out_bcount_opt(*BootOptionsLength) PBOOT_OPTIONS BootOptions, __inout PULONG BootOptionsLength);
NTSYSCALLAPI NTSTATUS NTAPI NtSetBootOptions (__in PBOOT_OPTIONS BootOptions, __in ULONG FieldsToChange);

#define BOOT_OPTIONS_FIELD_COUNTDOWN            0x00000001
#define BOOT_OPTIONS_FIELD_NEXT_BOOT_ENTRY_ID   0x00000002
#define BOOT_OPTIONS_FIELD_HEADLESS_REDIRECTION 0x00000004

NTSYSCALLAPI NTSTATUS NTAPI NtTranslateFilePath (__in PFILE_PATH InputFilePath, __in ULONG OutputType, __out_bcount_opt(*OutputFilePathLength) PFILE_PATH OutputFilePath, __inout_opt PULONG OutputFilePathLength);
...
NTSYSCALLAPI NTSTATUS NTAPI NtAddDriverEntry (__in PEFI_DRIVER_ENTRY DriverEntry, __out_opt PULONG Id);
NTSYSCALLAPI NTSTATUS NTAPI NtDeleteDriverEntry (__in ULONG Id);
NTSYSCALLAPI NTSTATUS NTAPI NtModifyDriverEntry (__in PEFI_DRIVER_ENTRY DriverEntry);
NTSYSCALLAPI NTSTATUS NTAPI NtEnumerateDriverEntries (__out_bcount(*BufferLength) PVOID Buffer, __inout PULONG BufferLength);
NTSYSCALLAPI NTSTATUS NTAPI NtQueryDriverEntryOrder (__out_ecount(*Count) PULONG Ids, __inout PULONG Count);
NTSYSCALLAPI NTSTATUS NTAPI NtSetDriverEntryOrder (__in_ecount(Count) PULONG Ids, __in ULONG Count);
...
NTSYSCALLAPI NTSTATUS NTAPI NtClearEvent (__in HANDLE EventHandle);
...
NTSYSCALLAPI NTSTATUS NTAPI NtOpenEvent (__out PHANDLE EventHandle, __in ACCESS_MASK DesiredAccess, __in POBJECT_ATTRIBUTES ObjectAttributes);
NTSYSCALLAPI NTSTATUS NTAPI NtPulseEvent (__in HANDLE EventHandle, __out_opt PLONG PreviousState);
...
NTSYSCALLAPI NTSTATUS NTAPI NtResetEvent (__in HANDLE EventHandle, __out_opt PLONG PreviousState);
NTSYSCALLAPI NTSTATUS NTAPI NtSetEvent (__in HANDLE EventHandle, __out_opt PLONG PreviousState);
NTSYSCALLAPI NTSTATUS NTAPI NtSetEventBoostPriority (__in HANDLE EventHandle);
...
NTSYSCALLAPI NTSTATUS NTAPI NtCreateEventPair (__out PHANDLE EventPairHandle, __in ACCESS_MASK DesiredAccess, __in_opt POBJECT_ATTRIBUTES ObjectAttributes);
NTSYSCALLAPI NTSTATUS NTAPI NtOpenEventPair (__out PHANDLE EventPairHandle, __in ACCESS_MASK DesiredAccess, __in POBJECT_ATTRIBUTES ObjectAttributes);
NTSYSCALLAPI NTSTATUS NTAPI NtWaitLowEventPair ( __in HANDLE EventPairHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtWaitHighEventPair (__in HANDLE EventPairHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtSetLowWaitHighEventPair (__in HANDLE EventPairHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtSetHighWaitLowEventPair (__in HANDLE EventPairHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtSetLowEventPair (__in HANDLE EventPairHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtSetHighEventPair (__in HANDLE EventPairHandle);
...
NTSYSCALLAPI NTSTATUS NTAPI NtCreateMutant (__out PHANDLE MutantHandle, __in ACCESS_MASK DesiredAccess, __in_opt POBJECT_ATTRIBUTES ObjectAttributes, __in BOOLEAN InitialOwner);
NTSYSCALLAPI NTSTATUS NTAPI NtOpenMutant (__out PHANDLE MutantHandle, __in ACCESS_MASK DesiredAccess, __in POBJECT_ATTRIBUTES ObjectAttributes);
...
NTSYSCALLAPI NTSTATUS NTAPI NtReleaseMutant (__in HANDLE MutantHandle, __out_opt PLONG PreviousCount);
...
NTSYSCALLAPI NTSTATUS NTAPI NtOpenSemaphore(__out PHANDLE SemaphoreHandle, __in ACCESS_MASK DesiredAccess, __in POBJECT_ATTRIBUTES ObjectAttributes);
...
NTSYSCALLAPI NTSTATUS NTAPI NtReleaseSemaphore(__in HANDLE SemaphoreHandle, __in LONG ReleaseCount, __out_opt PLONG PreviousCount);
...
typedef VOID (*PTIMER_APC_ROUTINE) (__in PVOID TimerContext, __in ULONG TimerLowValue, __in LONG TimerHighValue);

// end_ntddk


// Timer object function definitions.
NTSYSCALLAPI NTSTATUS NTAPI NtCreateTimer (__out PHANDLE TimerHandle, __in ACCESS_MASK DesiredAccess, __in_opt POBJECT_ATTRIBUTES ObjectAttributes, __in TIMER_TYPE TimerType);
NTSYSCALLAPI NTSTATUS NTAPI NtOpenTimer (__out PHANDLE TimerHandle, __in ACCESS_MASK DesiredAccess, __in POBJECT_ATTRIBUTES ObjectAttributes);
NTSYSCALLAPI NTSTATUS NTAPI NtCancelTimer (__in HANDLE TimerHandle, __out_opt PBOOLEAN CurrentState);
...
NTSYSCALLAPI NTSTATUS NTAPI NtQuerySystemTime (__out PLARGE_INTEGER SystemTime);
NTSYSCALLAPI NTSTATUS NTAPI NtSetSystemTime (__in_opt PLARGE_INTEGER SystemTime, __out_opt PLARGE_INTEGER PreviousTime);
NTSYSCALLAPI NTSTATUS NTAPI NtQueryTimerResolution (__out PULONG MaximumTime, __out PULONG MinimumTime, __out PULONG CurrentTime);
NTSYSCALLAPI NTSTATUS NTAPI NtSetTimerResolution (__in ULONG DesiredTime, __in BOOLEAN SetResolution, __out PULONG ActualTime);

//  Locally Unique Identifier (LUID) allocation
NTSYSCALLAPI NTSTATUS NTAPI NtAllocateLocallyUniqueId (__out PLUID Luid);

//  Universally Unique Identifier (UUID) time allocation
NTSYSCALLAPI NTSTATUS NTAPI NtSetUuidSeed (__in PCHAR Seed);
NTSYSCALLAPI NTSTATUS NTAPI NtAllocateUuids (__out PULARGE_INTEGER Time, __out PULONG Range, __out PULONG Sequence, __out PCHAR Seed);
...
NTSYSCALLAPI NTSTATUS NTAPI NtStartProfile (__in HANDLE ProfileHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtStopProfile (__in HANDLE ProfileHandle);
NTSYSCALLAPI NTSTATUS NTAPI NtSetIntervalProfile (__in ULONG Interval, __in KPROFILE_SOURCE Source);
NTSYSCALLAPI NTSTATUS NTAPI NtQueryIntervalProfile (__in KPROFILE_SOURCE ProfileSource, __out PULONG Interval);

// Performance Counter Definitions
NTSYSCALLAPI NTSTATUS NTAPI NtQueryPerformanceCounter (__out PLARGE_INTEGER PerformanceCounter, __out_opt PLARGE_INTEGER PerformanceFrequency);

#define KEYEDEVENT_WAIT 0x0001
#define KEYEDEVENT_WAKE 0x0002
#define KEYEDEVENT_ALL_ACCESS (STANDARD_RIGHTS_REQUIRED | KEYEDEVENT_WAIT | KEYEDEVENT_WAKE)

NTSYSCALLAPI NTSTATUS NTAPI NtCreateKeyedEvent (__out PHANDLE KeyedEventHandle, __in ACCESS_MASK DesiredAccess, __in_opt POBJECT_ATTRIBUTES ObjectAttributes, __in ULONG Flags);
NTSYSCALLAPI NTSTATUS NTAPI NtOpenKeyedEvent (__out PHANDLE KeyedEventHandle, __in ACCESS_MASK DesiredAccess, __in POBJECT_ATTRIBUTES ObjectAttributes);
NTSYSCALLAPI NTSTATUS NTAPI NtReleaseKeyedEvent (__in HANDLE KeyedEventHandle, __in PVOID KeyValue, __in BOOLEAN Alertable, __in_opt PLARGE_INTEGER Timeout);
NTSYSCALLAPI NTSTATUS NTAPI NtWaitForKeyedEvent (__in HANDLE KeyedEventHandle, __in PVOID KeyValue, __in BOOLEAN Alertable, __in_opt PLARGE_INTEGER Timeout);
...
typedef ULONG_PTR (*PDRIVER_VERIFIER_THUNK_ROUTINE) (IN PVOID Context);


//  This structure is passed in by drivers that want to thunk callers of their exports.
...
typedef struct _SYSTEM_HOTPATCH_CODE_INFORMATION {
    ...
    //  NOTE Do not add anything after CodeDescriptors array as it is assumed to have a variable size
...
// SysDbg APIs are available to user-mode processes via NtSystemDebugControl.
...
// WARNING: This structure must have exactly the same layout for 32- and 64-bit systems.
//    The layout of this structure cannot change and new fields can only be added at the end of the structure (unless a gap can be exploited).
//    Deprecated fields cannot be deleted. Platform specific fields are included on all systems.
...
typedef struct _KUSER_SHARED_DATA {
    ...
    volatile KSYSTEM_TIME InterruptTime;// Current 64-bit interrupt time in 100ns units.
    volatile KSYSTEM_TIME SystemTime;// Current 64-bit system time in 100ns units.
    volatile KSYSTEM_TIME TimeZoneBias;// Current 64-bit time zone bias.
    ...
    WCHAR NtSystemRoot[260];// Copy of system root in unicode.
    ULONG MaxStackTraceDepth;// Maximum stack trace depth if tracing enabled.
    ULONG CryptoExponent;// Crypto exponent value.
    ...
    // The NT Version.
    // N. B. Note that each process sees a version from its PEB, but if the process is running with an altered view of the system version, the following two fields are used to correctly identify the version
    ULONG NtMajorVersion;
    ULONG NtMinorVersion;

    BOOLEAN ProcessorFeatures[PROCESSOR_FEATURE_MAX];// Processor features.

    // Reserved fields - do not use.
    ULONG Reserved1;
    ULONG Reserved3;

    volatile ULONG TimeSlip;// Time slippage while in debugger.
    ALTERNATIVE_ARCHITECTURE_TYPE AlternativeArchitecture;// Alternative system architecture, e.g., NEC PC98xx on x86.

    // If the system is an evaluation unit, the following field contains the date and time that the evaluation unit expires.
    // A value of 0 indicates that there is no expiration. A non-zero value is the UTC absolute time that the system expires.
    LARGE_INTEGER SystemExpirationDate;

    ULONG SuiteMask;// Suite support.
    BOOLEAN KdDebuggerEnabled;// TRUE if a kernel debugger is connected/enabled.
    UCHAR NXSupportPolicy;// NX support policy.
    volatile ULONG ActiveConsoleId;// Current console session Id. Always zero on non-TS systems.

    // Force-dismounts cause handles to become invalid.
    // Rather than always probe handles, a serial number of dismounts is maintained that clients can use to see if they need to probe handles.
    volatile ULONG DismountCount;

    // This field indicates the status of the 64-bit COM+ package on the system.
    // It indicates whether the Intermediate Language (IL) COM+ images need to use the 64-bit COM+ runtime or the 32-bit COM+ runtime.
    ULONG ComPlusPackage;

    // Time in tick count for system-wide last user input across all terminal sessions.
    // For MP performance, it is not updated all the time (e.g. once a minute per session). It is used for idle detection.
    ULONG LastSystemRITEventTickCount;

    // Number of physical pages in the system.
    // This can dynamically change as physical memory can be added or removed from a running system.
    ULONG NumberOfPhysicalPages;

    BOOLEAN SafeBootMode;// True if the system was booted in safe boot mode.

    // The following field is used for heap and critcial sectionc tracing.
    // The last bit is set for critical section collision tracing and second last bit is for heap tracing.
    // Also the first 16 bits are used as counter.
    ULONG TraceLogging;

    // Depending on the processor, the code for fast system call will differ, Stub code is provided pointers below to access the appropriate code.
    ...
    ULONG Cookie;// Cookie for encoding pointers system wide.
    ULONG Wow64SharedInformation[MAX_WOW64_SHARED_ENTRIES];// Shared information for Wow64 processes.
...
FORCEINLINE ULONGLONG NtGetTickCount64 (VOID)
{
    ...
    return ((UInt32x32To64(TickCount.LowPart, USER_SHARED_DATA->TickCountMultiplier) >> 24) + (UInt32x32To64(TickCount.HighPart, USER_SHARED_DATA->TickCountMultiplier) << 8));
}

FORCEINLINE ULONG NtGetTickCount (VOID)
{
#if defined(_WIN64)
...
NTSYSCALLAPI NTSTATUS NTAPI NtQueryDefaultLocale (__in BOOLEAN UserProfile, __out PLCID DefaultLocaleId);
NTSYSCALLAPI NTSTATUS NTAPI NtSetDefaultLocale (__in BOOLEAN UserProfile, __in LCID DefaultLocaleId);
NTSYSCALLAPI NTSTATUS NTAPI NtQueryInstallUILanguage (__out LANGID *InstallUILanguageId);
NTSYSCALLAPI NTSTATUS NTAPI NtQueryDefaultUILanguage (__out LANGID *DefaultUILanguageId);
NTSYSCALLAPI NTSTATUS NTAPI NtSetDefaultUILanguage (__in LANGID DefaultUILanguageId);
NTSYSCALLAPI NTSTATUS NTAPI NtSetDefaultHardErrorPort(__in HANDLE DefaultHardErrorPort);
...
NTSYSCALLAPI NTSTATUS NTAPI NtShutdownSystem (__in SHUTDOWN_ACTION Action);
NTSYSCALLAPI NTSTATUS NTAPI NtDisplayString (__in PUNICODE_STRING String);
...
NTSYSCALLAPI NTSTATUS NTAPI NtAddAtom (__in_bcount_opt(Length) PWSTR AtomName, __in ULONG Length, __out_opt PRTL_ATOM Atom);
NTSYSCALLAPI NTSTATUS NTAPI NtFindAtom (__in_bcount_opt(Length) PWSTR AtomName, __in ULONG Length, __out_opt PRTL_ATOM Atom);
NTSYSCALLAPI NTSTATUS NTAPI NtDeleteAtom (__in RTL_ATOM Atom);
