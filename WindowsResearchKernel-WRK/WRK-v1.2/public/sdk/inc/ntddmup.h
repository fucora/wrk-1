...
Abstract:
    This is the include file that defines all constants and types for accessing the Multiple UNC provider system device.
*/
...
// It is the name that should be passed to NtOpenFile when accessing the device.
