...
Abstract:
    ...
    Definitions for generic international functions, mostly defines which map string/formatted-io/ctype functions to char, wchar_t, or MBCS versions.
    To be used for compatibility between single-byte, multi-byte and Unicode text models.
    [Public]
*/
