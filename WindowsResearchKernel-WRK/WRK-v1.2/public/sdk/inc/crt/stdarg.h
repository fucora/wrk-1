...
Abstract:
    ...
    This file defines ANSI-style macros for accessing arguments of functions which take a variable number of arguments.
    [ANSI]
    [Public]
*/
...
#define va_start(ap,v)  ( __va_start(&ap, _ADDRESSOF(v), sizeof(v), __builtin_alignof(v), _ADDRESSOF(v)) )
