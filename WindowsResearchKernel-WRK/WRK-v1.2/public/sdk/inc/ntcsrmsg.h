...
Abstract:
    This module defines the public message format shared by the client and server sides of the Client-Server Runtime (Csr) Subsystem.
*/
...
// This structure is filled in by the client prior to connecting to the CSR server.
// The CSR server will fill in the OUT fields if prior to accepting the connection.
...
// This helps out the Wow64 thunk generater, so we can change RelatedCaptureBuffer from struct _CSR_CAPTURE_HEADER* to PCSR_CAPTURE_HEADER.
