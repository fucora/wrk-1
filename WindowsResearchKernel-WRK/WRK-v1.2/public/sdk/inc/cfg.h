...
// The following definitions are also used by kernel mode code to set up the registry.
...
// IO_RESOURCE_DESCRIPTOR in the IO_RESOURCE_LIST. In this case, the descriptor type would be CmResourceTypeConfigData.
