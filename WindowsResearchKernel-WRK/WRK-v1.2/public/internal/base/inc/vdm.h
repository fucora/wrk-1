...
NTSYSCALLAPI NTSTATUS NtVdmControl (__in VDMSERVICECLASS Service, __inout PVOID ServiceData);
...
// There is code that assumes that an array of these structures will fit neatly into a 4096 byte page.
...
// Scratch areas are used from VDMTib to get user space while in kernel.
// This allows us to make Nt APIs (faster) from kernel rather than Zw apis (slower).
// These are currently being used for DOS read/write.
