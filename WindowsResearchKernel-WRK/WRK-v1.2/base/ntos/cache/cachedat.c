...
//  Store the current idle delay and target time to clean all.  We must calculate the idle delay in terms of clock ticks for the lazy writer timeout.
...
//  Spinlock for controlling access to Vacb and related global structures, and a counter indicating how many Vcbs are active.
...
//  Number of outstanding aggressive zeroers in the system.  Used to throttle the activity.
...
ULONG CcThrowAway;//  Throw away miss counter.
