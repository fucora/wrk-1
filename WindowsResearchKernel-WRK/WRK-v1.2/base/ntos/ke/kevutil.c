...
/*
Routine Description:
    This function returns the name of a driver based on the specified Address.
    In addition, the offset into the driver is returned along with an indication as to whether the driver is among the list of those being verified.
Arguments:
...
*/
{
    ...
    *OffsetIntoImage = 0;
    ...
    pModuleListHead = &PsLoadedModuleList;// Set initial values for the module walk
