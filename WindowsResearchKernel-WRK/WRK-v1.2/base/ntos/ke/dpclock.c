...
KIRQL FASTCALL KeAcquireSpinLockForDpc (__inout PKSPIN_LOCK SpinLock)
/*
Routine Description:
...
VOID FASTCALL KeReleaseSpinLockForDpc (__inout PKSPIN_LOCK SpinLock, __in KIRQL OldIrql)
/*
Routine Description:
...
VOID FASTCALL KeAcquireInStackQueuedSpinLockForDpc (__inout PKSPIN_LOCK SpinLock, __out PKLOCK_QUEUE_HANDLE LockHandle)
/*
Routine Description:
...
VOID FASTCALL KeReleaseInStackQueuedSpinLockForDpc (__in PKLOCK_QUEUE_HANDLE LockHandle)
/*
Routine Description:
