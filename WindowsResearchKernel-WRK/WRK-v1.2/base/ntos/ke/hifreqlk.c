...
Abstract:
    This module contains the declaration and allocation of high frequency spin locks.
*/
...
ALIGNED_SPINLOCK PsLoadedModuleSpinLock = 0;// Process structure spin locks.
ALIGNED_SPINLOCK NtfsStructLock = 0;// Ntfs spin locks.
ALIGNED_SPINLOCK AfdWorkQueueSpinLock = 0;// Afd spin locks.
