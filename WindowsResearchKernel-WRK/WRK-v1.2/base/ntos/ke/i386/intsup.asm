...
;    It contains the interrupt dispatch code and the code template that gets copied into an interrupt object.
...
;    execution of the service routine associated with the specified interrupt object.
; Arguments:
...
;       is to be synchronized with the execution of the service routine associated with the specified interrupt object.
;    SynchronizeContext - Supplies a pointer to an arbitrary data structure
;       which is to be passed to the function specified by the SynchronizeRoutine parameter.
; Return Value:
;    The value returned by the SynchronizeRoutine function is returned as the function value.
