...
typedef struct _NEW_PAT {
    PAT                 Attributes;    
    PROCESSOR_LOCKSTEP  Synchronize;// IPI context to coordinate concurrent PAT update
} NEW_PAT, *PNEW_PAT;
...
/*
Routine Description:
    Initialize the Page Attribute Table (PAT) on all processors. 
    PAT is setup to provide WB, WC, STRONG_UC and WEAK_UC as the memory
