...
;    This module implements procedures for saving and restoring processor control state, and processor run&control state.
...
; Routine Description:
;    This routine saves the processor state for debugger.
;    When the current processor receives the request of IPI_FREEZE, it saves all the registers
...
;         recursive hardware trace breakpoints and allows debuggers to work.
...
;    control returns from debugger (UnFreezeExecution), this function restores the entire processor state.
