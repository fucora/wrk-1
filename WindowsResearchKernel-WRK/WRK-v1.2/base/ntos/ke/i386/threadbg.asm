...
; Routine Description:
;    This routine is called at thread startup.
;    Its function is to call the initial thread procedure.
;    If control returns from the initial thread procedure and a user mode context was established when the thread was initialized, then the user mode context is restored and control is transferred to user mode.
;    Otherwise a bugcheck will occur.
; Arguments:
