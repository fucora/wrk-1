...
Abstract:
    This module contains code to manipulate i386 hardware structures used only by the kernel.
*/
...
/*
Routine Description:
    This function initializes machine type, i.e. MCA, ABIOS, ISA or EISA.
