...
; The new thread is the Idle thread (same as old thread).
; This can happen rarely when a thread scheduled for this processor is made unable to run on this processor.
; As this processor has again been marked idle, other processors may unconditionally assign new threads to this processor.
