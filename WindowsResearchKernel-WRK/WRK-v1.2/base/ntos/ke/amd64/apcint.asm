...
; Routine Description:
;   This routine is entered as the result of a software interrupt generated at APC_LEVEL.
;   Its function is to save the machine state and call the APC delivery routine.
;   N.B. This is a directly connected interrupt that does not use an interrupt object.
...
; N.B. If an APC interrupt occurs when idle halt is set, then the interrupt occurred during the power managment halted state.
;      The interrupt can be immediately dismissed since the idle loop will provide the correct processing.
...
; Routine Description:
;   This routine generates an exception frame and attempts to deliver a user APC.
; Arguments:
