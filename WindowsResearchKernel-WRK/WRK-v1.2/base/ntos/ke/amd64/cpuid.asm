...
; VOID KiCpuId (ULONG Function, ULONG Index, PCPU_INFO CpuInfo);
; Routine Description:
;   Executes the cpuid instruction and returns the resultant register values.
; Arguments:
...
; Return Value:
;   The return values from the cpuid instruction are stored in the specified cpu information structure.
