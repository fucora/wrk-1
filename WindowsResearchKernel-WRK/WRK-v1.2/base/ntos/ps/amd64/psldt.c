...
Arguments:
    ...
    ReturnLength - Supplies a pointer to a variable that receives the number of bytes returned in the information buffer.
Return Value:
...
Arguments:
    ...
    ThreadInformation - Supplies a pointer to the thread descriptor information.
    ThreadInformationLength - Supplies the length of the thread descriptor information.
    ReturnLength - Supplies a pointer to a variable that receives the number of bytes returned in the descriptor information buffer.
Return Value:
    STATUS_NOT_IMPLEMENTED
*/
{
