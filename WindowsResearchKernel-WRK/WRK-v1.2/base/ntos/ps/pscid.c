...
*/
{
    ...
    if (lThread != NULL) {
        ...
        if (lThread->Tcb.Header.Type != ThreadObject || lThread->Cid.UniqueProcess != Cid->UniqueProcess || lThread->GrantedAccess == 0) {
            ...
            *Thread = lThread;
            if (ARGUMENT_PRESENT(Process)) {
                ...
                *Process = lProcess;
                // Since the thread holds a reference to the process this reference does not have to be protected.
