...
typedef struct
{
    ...
    union
    {
        PHYSICAL_ADDRESS SingleBitEccAddress;// For SingleBitEcc type, indicates physical address of page where error occured
        ULONG CpuId;// For Cpu* types, indicates cpu on which the error occured
    };
...
// Maxiumum number of MCE events being tracked at one time.
// If there is more than this limit then the oldest ones are recycled.
