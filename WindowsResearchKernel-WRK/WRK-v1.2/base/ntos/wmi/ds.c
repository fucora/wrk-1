...
NTSTATUS WmipMangleInstanceName(
    IN  LPGUID  Guid,
    IN  PWCHAR  Name,
...
PWCHAR GuidToString(PWCHAR s, ULONG SizeInBytes, LPGUID piid);
...
*/
{
    ...
    if (RegEntry != NULL) {
        ...
        Status = WmipAddDataSource(RegEntry, &WmiReg.Info, WmiReg.Info.BufferSize, NULL, NULL, NULL, FALSE);
        if (NT_SUCCESS(Status)) {
