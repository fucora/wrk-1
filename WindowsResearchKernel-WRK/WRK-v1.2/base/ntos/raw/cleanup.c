...
Abstract:
    This module implements the File Cleanup routine for Raw called by the dispatch driver.
*/
...
NTSTATUS RawCleanup (IN PVCB Vcb, IN PIRP Irp, IN PIO_STACK_LOCATION IrpSp)
/*
Routine Description:
...
*/
{
    ...
    //  This is a Cleanup operation.  All we have to do is deal with share access.
    ...
    if (FlagOn( Vcb->VcbState,  VCB_STATE_FLAG_DISMOUNTED )) {
        ...
        //  We know the Vcb won't go away in this call because our reference keeps the OpenCount above zero.
