...
Abstract:
    This module implements the File Close routine for Raw called by the dispatch driver.
*/
...
NTSTATUS RawClose (IN PVCB Vcb, IN PIRP Irp, IN PIO_STACK_LOCATION IrpSp)
/*
Routine Description:
