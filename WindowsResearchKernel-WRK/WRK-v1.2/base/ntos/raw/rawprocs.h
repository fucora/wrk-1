...
Abstract:
    This module defines all of the globally used procedures in the Raw file system.
*/
...
//  These routines are called by RawDispatch via the I/O system via the dispatch table in the Driver Object.
//  If the status returned is not STATUS_PENDING, the Irp will be complete with this status.
NTSTATUS
