...
*/
{
    ...
    ObCreateObjectType( &PortTypeName, &ObjectTypeInitializer, (PSECURITY_DESCRIPTOR)NULL, &LpcPortObjectType );//  Create the object type for the port object
    ...
    ObCreateObjectType( &PortTypeName, &ObjectTypeInitializer, (PSECURITY_DESCRIPTOR)NULL, &LpcWaitablePortObjectType );//  Create the object type for the waitable port object
    ...
    LpcpInitializePortZone( ZoneElementSize );//  Initialize the zone
