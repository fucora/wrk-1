...
; Abstract:
;    This module implements functions to support interlocked S-List operations.
...
; PSINGLE_LIST_ENTRY FirstEntrySList (IN PSLIST_HEADER SListHead)

; Routine Description:
;   This function returns the address of the fisrt entry in the SLIST or NULL.

; Arguments:
;   ListHead (rcx) - Supplies a pointer to the sequenced listhead from which the first entry address is to be computed.

; Return Value:
;   The address of the first entry is the specified, or NULL if the list is empty.
...
; PSINGLE_LIST_ENTRY RtlpInterlockedPopEntrySList (IN PSINGLE_LIST_ENTRY ListHead)
