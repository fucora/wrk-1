...
Routine Description:
    ...
    The DestinationString is initialized to point to the SourceString and the Length and MaximumLength fields of DestinationString are
    initialized to the length of the SourceString, which is zero if SourceString is not specified.
Arguments:
...
Routine Description:
    ...
    The DestinationString is initialized to point to the SourceString and the Length and MaximumLength fields of DestinationString are initialized to the length of the SourceString,
...
NTSTATUS RtlInitAnsiStringEx(OUT PANSI_STRING DestinationString, IN PCSZ SourceString OPTIONAL)
{
    SIZE_T Length;
    ...
    if (ARGUMENT_PRESENT(SourceString)) {
        ...
        // We are actually limited to 64K - 1 characters since we want to store a meaningful MaximumLength also.
...
BOOLEAN RtlEqualString(IN const STRING *String1, IN const STRING *String2, IN BOOLEAN CaseInSensitive)
/*
Routine Description:
...
BOOLEAN RtlPrefixString(const STRING * String1, const STRING * String2, IN BOOLEAN CaseInSensitive)
/*
Routine Description:
...
*/
{
    ...
    if (ARGUMENT_PRESENT(Source)) {
        ...
        if ((n > MAXUSHORT) || ((n + Destination->Length) > Destination->MaximumLength)) {
...
NTSTATUS RtlAppendStringToString(IN PSTRING Destination, IN const STRING *Source)
/*
Routine Description:
...
Return Value:
   ...
   If all bytes compared equal, then the length of the original block of memory is returned.
