...
; Abstract:
;    This module implements supplementary routines for performing string operations.
...
;    (TOS+8) = SourceString - Optional pointer to a null terminated string that the counted string is to point to.
; Return Value:
;    None.
; NOTE:
