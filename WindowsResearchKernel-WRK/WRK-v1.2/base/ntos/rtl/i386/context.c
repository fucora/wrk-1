    ...
    */
{
    ...
    // Even though these are optional, they are used as is, since NULL is what these would have been initialized to anyway
...
NTSTATUS RtlRemoteCall(HANDLE Process,
    ...
    Arguments:
        ...
        ArgumentCount - Number of 32 bit parameters to pass to the target procedure.
    ...
    */
{
    ...
    //    Pass all parameters on the stack, regardless of whether a a context record is passed.
    ...
    // Set the address of the target code into Eip, the new target stack into Esp, and reload context to make it happen.
    Context.Esp = NewSp;
