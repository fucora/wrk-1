...
Abstract:
    This header contains prototypes for verifying Power IRPs are handled correctly.
*/
...
BOOLEAN FASTCALL VfPowerIsSystemRestrictedIrp(IN PIO_STACK_LOCATION IrpSp);
BOOLEAN
FASTCALL
