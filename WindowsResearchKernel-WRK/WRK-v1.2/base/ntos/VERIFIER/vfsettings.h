...
Abstract:
    This header contains prototypes for manipulating verifier options and values.
*/
...
typedef enum {
    ...
    // The particular IRP sent is of type -1, and has a -1 passed in for the device list.
...
ULONG FASTCALL VfSettingsGetSnapshotSize(VOID);
