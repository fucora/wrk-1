...
NTSTATUS NtQuerySection(__in HANDLE SectionHandle,
    ...
    Arguments:
        ...
        SectionInformation - A pointer to a buffer that receives the specified information.
                             The format and content of the buffer depend on the specified section class.
    ...
    */
{
    ...
    // Reference section object by handle for READ access, get the information from the section object, dereference the section object,
    // fill in information structure, optionally return the length of the information structure, and return service status.
