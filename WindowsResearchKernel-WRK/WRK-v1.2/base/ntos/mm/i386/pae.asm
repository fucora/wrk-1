...
; ULONGLONG InterlockedExchangePte (IN OUT PMMPTE Destination, IN ULONGLONG Exchange)
; Routine Description:
;     This function performs an interlocked swap of a PTE.
;     This is only needed for the PAE architecture where the PTE width is larger than the register width.
