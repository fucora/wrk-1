...
Routine Description:
    ...
    This mask has the valid and access bits set and has the global and owner bits set based on the address of the PTE.

    ***  NOTE ******
        THIS ROUTINE DOES NOT CHECK FOR PDEs WHICH NEED TO BE
        SET GLOBAL AS IT ASSUMES PDEs FOR SYSTEM SPACE ARE PROPERLY SET AT INITIALIZATION TIME!
...
*/
{
    ...
    // Since the valid, accessed, global and owner bits are always in the low dword of the PTE, returning a ULONG is ok.
