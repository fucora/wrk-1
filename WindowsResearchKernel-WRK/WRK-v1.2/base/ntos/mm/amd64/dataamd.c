...
const MMPTE ZeroPte = {0};// A zero Pte.
const MMPTE ZeroKernelPte = {0x0};// A kernel zero PTE.

MMPTE ValidKernelPte = {MM_PTE_VALID_MASK | MM_PTE_WRITE_MASK | MM_PTE_GLOBAL_MASK | MM_PTE_DIRTY_MASK | MM_PTE_ACCESS_MASK};
...
MMPTE ValidKernelPde = {MM_PTE_VALID_MASK | MM_PTE_WRITE_MASK | MM_PTE_GLOBAL_MASK | MM_PTE_DIRTY_MASK | MM_PTE_ACCESS_MASK};
...
const MMPTE TransitionPde = {MM_PTE_WRITE_MASK | MM_PTE_OWNER_MASK | MM_PTE_TRANSITION_MASK | MM_READWRITE << MM_PROTECT_FIELD_SHIFT};
