...
// File systems interested in being notified when a logon session is being terminated register a callback routine.
// The following data structure describes the callback routines.
