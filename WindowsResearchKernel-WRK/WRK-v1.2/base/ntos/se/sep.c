...
Abstract:
    This Module implements the private security routine that are defined in sep.h
*/
...
Arguments:
    ...
    Length - Supplies the real size of the acl.  The internal acl size must agree.
Return Value:
