...
void SPACE_MapMemory(ulong ctx, ulong vpage, ulong ppage, ulong readmask, ulong writemask)
{
...
void SPACE_DestroyPortal(ulong portalid)
{
...
void SPACE_Resume      (ulong64 result)
{
...
void SPACE_Unsuspend(SPACETOKEN token)
{
    Split64 x;
    x.all  = token;
...
void SPACE_DiscardToken(SPACETOKEN token)
{
    Split64 x;
    x.all  = token;
...
void SPACE_StartCPU(ulong boot_cpu, ulong boot_ctx, ulong boot_mode, ulong boot_pc, ulong boot_arg)
{
...
void SPACE_HaltCPU(ulong reason)
{
...
ulong64 SPACE_AccessDevice(ushort deviceid, uchar op, uchar deviceregister, ulong value, ulong valuex)
{
...
void SPACE_InterruptCPU(ushort targetcpu, uchar interrupt, uchar irql)
{
...
void SPACE_SPACEBreak(ulong   breakvalue, char   *breakmsg)
{
    XSPACEBreak u = { 0 };
