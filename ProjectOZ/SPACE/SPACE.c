...
int main(int ac, char *argv[])
{
    ...
    s = NtCreateSection(&spaceglobals.physmemsection, SECTION_ALL_ACCESS, NULL, &physmemsize, PAGE_EXECUTE_READWRITE, SEC_COMMIT, NULL);
    ...
    RegisterAllDevices();// Register the device emulations
    SPACEEmulation();// Start SPACE Emulation loop
