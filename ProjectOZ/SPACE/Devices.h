...
NTSTATUS    StartDMA        (ULONG cpu, ULONG deviceid, PCHAR devicememory, ULONG_PTR base, ULONG bytecount, BOOLEAN writememory, DMACOMPLETECALLBACK callback, PVOID callbackcontext);
